  ...
  useEffect(() => {
    if (id && existingQuiz) {
      form.reset({
        ...
        feedback_timing: existingQuiz.feedback_timing || (existingQuiz.show_feedback === false ? 'never' : 'end_of_quiz'),
  ...
  const handleSave = async (publish: boolean = false) => {
    ...
    try {
      ...
      const quizPayload = {
        ...
        feedback_timing: metadata.feedback_timing,
