 ...
 const models = [
   { id: "google/gemini-2.5-flash", name: "Gemini 2.5 Flash", description: "Sürətli və effektiv" },
   { id: "google/gemini-2.5-pro", name: "Gemini 2.5 Pro", description: "Daha dəqiq və güclü" },
   { id: "google/gemini-3-flash-preview", name: "Gemini 3 Flash", description: "Yeni nəsil model" },
   { id: "openai/gpt-5-mini", name: "GPT-5 Mini", description: "Balanslaşdırılmış" },
 ];
           ...
           >
             <div className="flex items-center gap-2">
               ...
               <span className="text-xs text-muted-foreground">
                 ({selectedModel?.name}, T: {parameters.temperature})
               </span>
             </div>
             {isOpen ? (
