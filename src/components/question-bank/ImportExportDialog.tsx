...
### Format 2: Test üslubu (Nömrəli + Variantlar)
1. Azərbaycan Respublikasının paytaxtı haradır?
A) Gəncə
B) Bakı
C) Sumqayıt
...
Taqlar: azərbaycan, paytaxt

---

### Format 3: Sadə siyahı (Bullet + Rəqəm)
1
Dövlət dilimiz hansıdır?
- Azərbaycan dili
- İngilis dili
- Alman dili

Cavab: Azərbaycan dili`,
...
const FORMAT_INFO: Record<string, string> = {
  ...
  markdown: "Notepad, Apple Notes və ya Word-dən kopyalanmış suallar üçün ən tolerant formatdır. Həm başlıq, həm də nömrəli siyahıları dəstəkləyir."
};
