    ...
    return (
        <div className="space-y-6 pt-4 border-t">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Question Image */}
                {/* Question Image Preview (Moved to main view, but keep a small indicator here if needed or just remove) */}
            ...
            {/* Video Specific - Show if type is video OR media_type is video */}
